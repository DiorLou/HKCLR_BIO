...
private slots:
    ...
    void slot_getRobotParameters_result(QObject *obj, QString robotModel);
    void slot_loadRobotModelSegment_result(QObject *obj,
                                           osg::Node *linkSTL,
                                           osg::Node *link3DS,
...
private:
    ...
    void allocationRobotModelLoading(const QString &robotType);

    void readRobotModelSuccess();
