...
{
    // Keep the complete legacy teaching object graph and its controller signal
    // connections alive, but do not register the page in the main tab bar.
    // Several controller initialization paths historically live in this form.
    m_iMainTabIndex = -1;
